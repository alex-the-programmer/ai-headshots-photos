...
export type Mutation = {
  ...
  registerExpoPushToken?: Maybe<RegisterExpoPushTokenPayload>;
...
/** Autogenerated input type of RegisterExpoPushToken */
export type RegisterExpoPushTokenInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  expoPushToken: Scalars['String']['input'];
};

/** Autogenerated return type of RegisterExpoPushToken. */
export type RegisterExpoPushTokenPayload = {
  __typename?: 'RegisterExpoPushTokenPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  user: User;
};
...
export type RegisterExpoPushTokenMutation = { __typename?: 'Mutation', registerExpoPushToken?: { __typename?: 'RegisterExpoPushTokenPayload', user: { __typename?: 'User', id: string } } | null };
...
export const RegisterExpoPushTokenDocument = gql`
  ...
  registerExpoPushToken(input: $input) {
    ...
    `;
export type RegisterExpoPushTokenMutationFn = Apollo.MutationFunction<RegisterExpoPushTokenMutation, RegisterExpoPushTokenMutationVariables>;

/**
 * __useRegisterExpoPushTokenMutation__
 *
 * To run a mutation, you first call `useRegisterExpoPushTokenMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRegisterExpoPushTokenMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [registerExpoPushTokenMutation, { data, loading, error }] = useRegisterExpoPushTokenMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useRegisterExpoPushTokenMutation(baseOptions?: Apollo.MutationHookOptions<RegisterExpoPushTokenMutation, RegisterExpoPushTokenMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RegisterExpoPushTokenMutation, RegisterExpoPushTokenMutationVariables>(RegisterExpoPushTokenDocument, options);
      }
export type RegisterExpoPushTokenMutationHookResult = ReturnType<typeof useRegisterExpoPushTokenMutation>;
export type RegisterExpoPushTokenMutationResult = Apollo.MutationResult<RegisterExpoPushTokenMutation>;
export type RegisterExpoPushTokenMutationOptions = Apollo.BaseMutationOptions<RegisterExpoPushTokenMutation, RegisterExpoPushTokenMutationVariables>;
