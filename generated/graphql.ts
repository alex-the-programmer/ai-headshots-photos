...
export type Mutation = {
  ...
  verifyApplePayment?: Maybe<VerifyApplePaymentPayload>;
...
export type MutationVerifyApplePaymentArgs = {
  input: VerifyApplePaymentInput;
};
...
/** Autogenerated input type of VerifyApplePayment */
export type VerifyApplePaymentInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  orderId: Scalars['ID']['input'];
};

/** Autogenerated return type of VerifyApplePayment. */
export type VerifyApplePaymentPayload = {
  __typename?: 'VerifyApplePaymentPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  order: Order;
};
